...
return (
    ...
    <section class="row mx-0">
      <div class="col-md-9 bg-white">
        ...
        <hr />
        <img  class="float-md-left mr-2 img-fluid" src={port3} alt="placholder nature" style={{width: 350}}/>
        <p>
        ...
        <p>
        I am married to my high school sweetheart and we have been together for over 15 years and married for 13 years this December. My wife and I have 3 children, all girls, with ages from 4-8. My youngest 2 daughters are 13 months apart from each other and are very close. A few interesting facts is that I have a daughter born on National Slushie day (07/11), a daughter born on Ground Hogs day, and a daughter born on St. Patrick's day. My family and I live in a town known as Christmas Town USA. In December my entire town decorates their homes with Christmas lights and people come from all around to see the lights. 
        </p>
      </div>
    </section>
  </main>
